/* initial.c (acdc) - copyright Mike Arnautov 1990-2020.
...
struct directive keywords[] =
{
   ...
   {"parser",      MAJOR, PARSER,      2,   ANY_NUMBER},
   {"comma",       MAJOR, COMMA,       1,   ANY_NUMBER},
   {"semicolon",   MAJOR, SEMICOLON,   1,   ANY_NUMBER},
   {"repeater",    MAJOR, REPEATER,    1,   ANY_NUMBER},
   ...
   {"delete",      MINOR, DELETE,      FREE_ARG,   2},
