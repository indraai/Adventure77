/* getnames.c (acdc) - copyright Mike Arnautov 1990-2020.
 * Licensed under GPL, version 3 or later (see the supplied LICENCE file).
 *
 * 07 Aug 20   MLA           Fiddle tp offset for PARSER major type.
...
struct node *getnames (int major_type, struct node *gp)
{
   ...
   if (major_type == PARSER)
   {
      offset = 1;   // Actual args are offset by one token
      index = 1;
      major_type = VERB;
   }
